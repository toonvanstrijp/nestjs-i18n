...
import { NestMiddlewareConsumer, Path, Translations } from '../types';
...
export function i18nValidationMessage<K = Translations>(
  key: Path<K>,
  args?: any,
) {
...
export function formatI18nErrors<K = Translations>(
